...
<!-- [ ]TODO:INICIO atualizar -->
para criar uma conta e se inscreverem na disciplina criada dentro do URI. A disciplina tem o nome: IP_SIS_Not_D [2023-1].  

<!-- [ ]TODO:INICIO atualizar -->
Assim que acessar a disciplina informe a seguinte chave de acesso (token): z6LcTce  
...
5) copie o algoritmo do VSCode (selecionando todo o texto) para o editor do URI cole o algoritmo desenvolvido;  
